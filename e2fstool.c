...
void usage(int ret)
{
    fprintf(stderr, "%s [-c config_dir] [-C config_prefix] [-m mountpoint]\n"
...
int main(int argc, char *argv[])
{
    ...
    while ((c = getopt (argc, argv, "b:c:C:ehm:qlvV")) != EOF) {
        switch (c) {
        case 'b':
